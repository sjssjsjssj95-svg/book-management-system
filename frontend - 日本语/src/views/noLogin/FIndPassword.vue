<template>
    ...
    <div class="parent" >
         <el-form :model="form" label-width="auto" :class="animass">
            <h2 style="text-align: center;width: 100%;" >パスワードを再設定</h2>
            ...
            <el-form-item>
                <div style="text-align: center;width: 100%;">
                    <el-button type="primary"  @click="registerSend">パスワードを再設定</el-button>
                    <el-button @click="toLogin">ログインに戻る</el-button>
                </div>
            </el-form-item>
        </el-form>
    </div>
