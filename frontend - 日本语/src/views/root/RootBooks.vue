            ...
            <el-container>
                ...
                <el-main style="background-color: #E0E0E0;" v-loading="mainLoading" >
                    <div style="text-align: right;">
                        ...
                        <el-button type="primary" style="margin-left: 10px;" @click="newBookDrawer=true">新しい書籍を追加</el-button>
                        <el-button type="primary" style="margin-left: 10px;" @click="categoryDrawer=true">カテゴリ管理</el-button>
                    </div>
                    <el-row :gutter="20">
                    ...
                    <div style="width: 100%;" v-for="value in booksLength">
                        <el-divider style="border-color: #2f4050;"/>
                         <el-row :gutter="20">
                            ...
                            <el-col :span="3" style="display: flex; justify-content: center;align-items: center;">
                                <el-button type="warning" @click="openChangeDrawer(value)">編集</el-button>
                                <el-popconfirm
                                    class="box-item"
                                    title="削除してもよろしいですか？"
                                    placement="top-end"
