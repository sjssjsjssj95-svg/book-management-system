<template>
    ...
    <div class="parent" >
         <el-form :model="form" label-width="auto" :class="animass">
            <h2 style="text-align: center;width: 100%;" >注册</h2>
            <el-form-item label="账户" style="width: calc(25vw);">
                <el-input v-model="form.account" placeholder="最少需要3个字符"/>
            </el-form-item>

            <el-form-item label="密码" style="width: calc(25vw);">
                <el-input v-model="form.password" type="password" show-password placeholder="最少需要6个字符"/>
            </el-form-item>

            <el-form-item label="昵称" style="width: calc(25vw);">
                <el-input v-model="form.name"  placeholder="最少需要2个字符"/>
            </el-form-item>
            ...
            <el-form-item>
                <div style="text-align: center;width: 100%;">
                    <el-button type="primary"  @click="registerSend">立马注册</el-button>
                    <el-button @click="toLogin">已经有账户了？立马登录</el-button>
                </div>
            </el-form-item>
        </el-form>
    </div>
